...
/* harmony import */ var _wow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./wow */ "./src/js/wow.js");
...
var modals = function modals() {
  var btnPressed = false; //переопределение значения в стр 24
  ...
  function smoothModalSwitcher() {
    ...
    var scrollWidth = div.offsetWidth - div.clientWidth; // динамически получаем ширину скрола
  ...
  function openByScroll(selector) {
    ...
    window.addEventListener('scroll', function () {
      ...
      var scrollHeight = Math.max(document.documentElement.clientHeight, document.body.clientHeight); // document.documentElement = html

      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeight) {
        // pageYOffset - сколько сверху уже прокручено
